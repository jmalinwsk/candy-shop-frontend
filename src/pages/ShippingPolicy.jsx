...
const ShippingPolicy = () => {
  ...
  <>
      ...
      <Breadcrumbs />
      <TableOfContents />
    <div className="shipping-policy-wrapper py-3">
        ...
        <div className="row">
          <div className="col-12">
            <main>
              ...
              <p>
                samplepage.com proudly offers shipping services. Be assured we
                are doing everything in our power to get your order to you as
                soon as possible. Please consider any holidays that might impact
                delivery times. samplepage.com also offers same day dispatch.
              </p>
              ...
              <h3 id="shipping-wrong-address">Wrong Address Disclaimer</h3>
              <p>
              ...
              <h3 id="shipping-undeliverable-orders">Undeliverable Orders</h3>
              <p>
              ...
              <h3 id="shipping-return">Return Request Days</h3>
              <p>
                samplepage.com allows you to return its item (s) within a period
                of 14 days. Kindly be advised that the item (s) should be
                returned unopened and unused.
              </p>
              <h3 id="shipping-out-of-stock">Out Of Stock Item Process</h3>
              <p>
                In case of out-of-stock, samplepage.com Wait for all items to be
                in stock before dispatching.
              </p>
              <h3 id="shipping-taxes">Import Duty and Taxes</h3>
              <p>
                When working with samplepage.com, you have the following options
                when it comes to taxes as well and import taxes: customer will
                need to settle fees when arriving in destination country.
              </p>
              <h3 id="shipping-acceptance">Acceptance</h3>
              <p>
                By accessing our site and placing an order you have willingly
                accepted the terms of this Shipping Policy.
              </p>
              <h3 id="shipping-contact">Contact</h3>
              <p>
