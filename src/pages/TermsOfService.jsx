...
const TermsOfService = () => {
  return (
    <>
      <Meta title={"Terms of Service - Candy Shop"} />
      <Breadcrumbs />
      <TableOfContents />
      <SectionContainer className="tos-wrapper py-3">
      <div className="col-12">
              
              <h3 className="section-heading" id="tos-terms-conditions">
              ...
              <h3 className="section-heading" id="tos-interpretation">
                Interpretation
              </h3>
              <p className="text-justify">
              ...
              <h3 className="section-heading" id="tos-definitions">
                Definitions
              </h3>
              <p className="text-justify">
              ...
              <ul>
                ...
                <li>
                  <p className="text-justify">
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Candy Shop,
                    330 XXX XXXXX, New York, NY 100XX.
                  </p>
                </li>
                <li>
                  <p className="text-justify">
                ...
                <li>
                  <p className="text-justify">
                    <strong>Website</strong> refers to Candy Shop, accessible
                    from{" "}
                    <a
                      href="samplepage.com"
              ...
              <h3 className="section-heading" id="tos-acknowledgement">
                Acknowledgment
              </h3>
              <p className="text-justify">
              ...
              <h3 className="section-heading" id="tos-links">
              ...
              <h3 className="section-heading" id="tos-termination">
                Termination
              </h3>
              <p className="text-justify">
              ...
              <h3
                ...
                id="tos-limitations-of-liability"
              >
              ...
              <h3 className="section-heading" id="tos-governing-law">
                Governing Law
              </h3>
              <p className="text-justify">
              ...
              <h3 className="section-heading" id="tos-disputes">
                Disputes Resolution
              </h3>
              <p className="text-justify">
              ...
              <h3 className="section-heading" id="tos-eu">
              ...
              <h3 className="section-heading" id="tos-us">
              ...
              <h3 className="section-heading" id="tos-severability-waiver">
                Severability and Waiver
              </h3>
              <h4 className="subsection-heading" id="tos-severability">
                Severability
              </h4>
              <p className="text-justify">
              ...
              <h4 className="subsection-heading" id="tos-waiver">
                Waiver
              </h4>
              <p className="text-justify">
              ...
              <h3 className="section-heading" id="tos-translation">
              ...
              <h3 className="section-heading" id="tos-changes">
              ...
              <h3 className="section-heading" id="tos-contact">
                Contact Us
              </h3>
              <p className="text-justify">
