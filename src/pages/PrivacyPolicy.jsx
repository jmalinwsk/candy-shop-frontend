          ...
          <div className="row">
            <div className="col-12">
              <main>
                ...
                <h3 id="privacy-interpretation-definitions">
                  Interpretation and Definitions
                </h3>
                <h4 id="privacy-interpretation">Interpretation</h4>
                <p>
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      <strong>Application</strong> refers to Candy Shop, the
                ...
                <h3 id="privacy-collecting-using-data">
                  Collecting and Using Your Personal Data
                </h3>
                <h4 id="privacy-data">Personal Data</h4>
                <p>
                ...
                <h4 id="privacy-usage-data">Usage Data</h4>
                <p>
                ...
                <h4 id="privacy-personal-data-usage">
                ...
                <h4 id="privacy-retention">Retention of Your Personal Data</h4>
                <p>
                ...
                <h4 id="privacy-transfer">Transfer of Your Personal Data</h4>
                <p>
                ...
                <h4 id="privacy-delete">Delete Your Personal Data</h4>
                <p>
                ...
                <h3 id="privacy-disclosure">
                  Disclosure of Your Personal Data
                </h3>
                <h4 id="privacy-transactions">Business Transactions</h4>
                <p>
                ...
                <h4 id="privacy-law-enforcement">Law enforcement</h4>
                <p>
                ...
                <h4 id="privacy-other">Other legal requirements</h4>
                <p>
                ...
                <h4 id="privacy-security">Security of Your Personal Data</h4>
                <p>
                ...
                <h3 id="privacy-childrens-privacy">Children's Privacy</h3>
                <p>
                ...
                <h3 id="privacy-links">Links to Other Websites</h3>
                <p>
