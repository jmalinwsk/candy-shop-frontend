    ...
    <>
      ...
      <div className="faq-wrapper py-3">
        ...
        <main>
          ...
          <p>{sampleText}</p>
          <h4 id="shipping-howlong">How long does it take to ship my order?</h4>
          <p>{sampleText}</p>
          ...
          <p>{sampleText}</p>
          <h4 id="shipping-taxes">Will I pay taxes for international shipping?</h4>
          <p>{sampleText}</p>
          ...
          <p>{sampleText}</p>
          <h4 id="returns-howlong">How long does it take to process a return?</h4>
          <p>{sampleText}</p>
          <h3 id="other-questions">Other questions</h3>
          <h4 id="other-referralprogram">Do you offer a referral program? How does it work?</h4>
          <p>{sampleText}</p>
          <h4 id="other-physicalstores">Do you have physical stores?</h4>
          <p>{sampleText}</p>
          <h4 id="other-warranty">Is there a warranty?</h4>
          <p>{sampleText}</p>
          <h4 id="other-return-howlong">How long does it take to process a return?</h4>
          <p>{sampleText}</p>
        </main>
