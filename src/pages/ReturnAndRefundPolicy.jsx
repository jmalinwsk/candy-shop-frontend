...
const Returns = () => {
  return (
    <>
      <Meta title={"Return and Refund Policy - Candy Shop"} />
      <Breadcrumbs />
      <TableOfContents />
      <div className="return-and-refund-policy-wrapper py-3">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
              <main>
                <h3 id="refund-main">Return and Refund Policy</h3>
                <p>Thank you for shopping at Candy Shop.</p>
                <p>
                ...
                <h3 id="refund-interpretation-definitions">
                  Interpretation and Definitions
                </h3>
                <h4 id="refund-interpreration">Interpretation</h4>
                <p>
                ...
                <h3 id="refund-rights">Your Order Cancellation Rights</h3>
                <p>
                ...
                <h3 id="refund-conditions">Conditions for Returns</h3>
                <p>
                ...
                <h3 id="refund-returns">Returning Goods</h3>
                <p>
                ...
                <h3 id="refund-contact">Contact Us</h3>
                <p>
